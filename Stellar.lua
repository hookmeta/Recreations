getgenv().Stellar = {
    ...
    Camlock = {
        ...
        Sensitivity                  = 0.25,
        Prediction                   = 0.1215986298619862, -- // Prediction
        Toggle                       = "C", -- // Keybind
        Part                         = "HumanoidRootPart", -- // AimPart
        AirPart                      = "LowerTorso", -- // AimPart when Target is in air
        AirSmoothing                 = 0.052, -- // Smoothing when Target is in air
        AirPrediction                = 0.1215986298619862, -- // Predicition when Target is in air
